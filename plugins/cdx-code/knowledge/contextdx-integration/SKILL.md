...
When converting from internal format to ClaudeCodePlugin:

| Internal Field         | ClaudeCodePlugin Field   | Notes                                                   |
| ---------------------- | -------------------- | ------------------------------------------------------- |
...
1. **Load configuration** - Read ClaudeCodePlugin credentials
2. **Load board manifest** - Read `.contextdx/boards/manifest.json`
3. **Load analysis data** - Read `.contextdx/boards/<board-slug>.json`
4. **Transform data** - Convert internal format to ClaudeCodePlugin format
...
| `baseUrl`      | No       | https://api.contextdx.dev | API endpoint                |
...
### Example 1: Push architecture analysis to ClaudeCodePlugin

User says: "Sync my analysis to ClaudeCodePlugin"

Actions:
1. Load configuration from `.contextdx/config.json`
2. Load analysis data from `.contextdx/boards/<board-slug>.json`
3. Transform nodes and edges to ClaudeCodePlugin format
...
User says: "Connect to ClaudeCodePlugin"
