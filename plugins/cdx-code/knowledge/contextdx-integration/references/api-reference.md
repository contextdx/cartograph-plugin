...
| -------- | ------------------ | -------- | --------------------------------------- |
| `nodes`  | ClaudeCodePluginNode[] | Yes      | Array of nodes to push                  |
| `edges`  | ClaudeCodePluginEdge[] | Yes      | Array of edges to push                  |
| `branch` | string             | No       | Must match binding's branch if provided |
| `mode`   | string             | No       | `merge` (default) or `replace`          |

**ClaudeCodePluginNode Object:**
