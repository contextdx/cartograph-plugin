#!/usr/bin/env node
"use strict";var g=Object.create;var u=Object.defineProperty;var m=Object.getOwnPropertyDescriptor;var d=Object.getOwnPropertyNames;var f=Object.getPrototypeOf,h=Object.prototype.hasOwnProperty;var v=(t,n,s,r)=>{if(n&&typeof n=="object"||typeof n=="function")for(let i of d(n))!h.call(t,i)&&i!==s&&u(t,i,{get:()=>n[i],enumerable:!(r=m(n,i))||r.enumerable});return t};var p=(t,n,s)=>(s=t!=null?g(f(t)):{},v(n||!t||!t.__esModule?u(s,"default",{value:t,enumerable:!0}):s,t));var l=p(require("fs")),e=p(require("path"));function C(){let t=process.argv.slice(2),n={pluginRoot:e.resolve(__dirname,"..")};for(let s=0;s<t.length;s++)switch(t[s]){case"--plugin-root":n.pluginRoot=e.resolve(t[++s]);break;case"--help":console.log(`
ClaudeCodePlugin Help CLI
