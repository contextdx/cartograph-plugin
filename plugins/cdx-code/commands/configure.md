---
description: Configure ClaudeCodePlugin credentials and settings
allowed-tools: Read, Write, Bash, AskUserQuestion
---

Set up ClaudeCodePlugin configuration for architecture sync.
...
1. Go to the ContextDx UI → ClaudeCodePlugin dashboard
2. Create/bind a ClaudeCodePlugin source to a workboard
